Module GeneraPersonas
    ...
    Sub GeneraPersonas()
        Dim TaAnexos As New ProductionDSTableAdapters.AnexosTableAdapter
        Dim TaClientes As New ProductionDSTableAdapters.ClientesTableAdapter
        Dim TaPersonas As New ProductionDSTableAdapters.HistoriaPersonasTableAdapter
        Dim Tanexos As New ProductionDS.AnexosDataTable
        Dim TClientes As New ProductionDS.ClientesDataTable
        Dim RCli As ProductionDS.ClientesRow
        Dim taAvales As New ProductionDSTableAdapters.AvalesPLDTableAdapter
        Dim tAvales As New ProductionDS.AvalesPLDDataTable
        Dim Cad As String
        ...
        For Each rAne As ProductionDS.AnexosRow In Tanexos.Rows
        ...
        Cont = 0
        For Each rr As ProductionDS.AvalesPLDRow In tAvales.Rows
            Try
                Cont += 1
    ...
    Sub Actualiza_saldos(Modo As String)
        Dim taEquipo As New ProductionDSTableAdapters.TablaEquipo1TableAdapter
        Dim taSeg As New ProductionDSTableAdapters.TablaSeguro1TableAdapter
        Dim tEquipo As New ProductionDS.TablaEquipo1DataTable
        Dim tSeg As New ProductionDS.TablaSeguro1DataTable
        Dim TaAnexos As New ProductionDSTableAdapters.AnexosTableAdapter
        Dim taPersonas As New ProductionDSTableAdapters.HistoriaPersonasTableAdapter
        Dim Tpersonas As New ProductionDS.HistoriaPersonasDataTable
        ...
        For Each r As ProductionDS.HistoriaPersonasRow In Tpersonas.Rows
    ...
    Public Sub TraeSald(ByVal drVencimientos As DataTable, ByVal cFeven As String, ByRef nSaldo As Decimal, ByRef nInteres As Decimal, ByRef nCartera As Decimal, Optional ByVal cTipar As String = "")
        ...
        If drVencimientos.Rows.Count > 0 Then
            ...
            If cTipar = "P" Then
                Dim Ta As New ProductionDSTableAdapters.OpcionesTableAdapter
    ...
    Private Sub EnviaError(ByVal Para As String, ByVal Mensaje As String, ByVal Asunto As String)
        If InStr(Mensaje, Asunto) = 0 Then
            ...
            Dim Cliente As New System.Net.Mail.SmtpClient(My.Settings.SMTP, My.Settings.SMTP_port)
            Try
